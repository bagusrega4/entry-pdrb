...
use App\Exports\PriceProductionExport;
use Maatwebsite\Excel\Facades\Excel;
use App\Imports\PriceProductionImport;
...
class PriceProductionController extends Controller
{
        ...
        foreach ($data as $row) {
            ...
            CommodityPriceProduction::updateOrCreate(
                ...
                [
                    ...
                    'produksi' => isset($row['produksi']) ? $row['produksi'] : null,
                ]
            );
        }
    ...
    public function downloadTemplate(Request $request)
    {
        ...
        return Excel::download(
            new PriceProductionExport($roots),
            'template_harga_produksi.xlsx'
        );
    }
    ...
    public function importExcel(Request $request)
    {
        ...
        $import = new PriceProductionImport($path);
