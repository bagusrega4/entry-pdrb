...
<div class="page">
    ...
    <h3 class="fw-bold mb-3">Leontief Inverse — Multiplier</h3>
    ...
    <div class="card">
        ...
        <div class="card-head">
            <div class="card-head-left">
                ...
                <span class="card-head-title">Matriks Leontief Inverse (I - A)⁻¹</span>
            </div>
                ...
                <thead>
                    <tr>
                        ...
                        @for($j = 1; $j <= $dataset->jumlah_sektor; $j++)
                            <th>{{ $sektors[$j-1]->nama ?? 'Sektor '.$j }}</th>
                        @endfor
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        @for($j = 1; $j <= $dataset->jumlah_sektor; $j++)
                        <td>{{ number_format($inverse[$i][$j], 4) }}</td>
                        @endfor
                    </tr>
                    @endfor
                </tbody>
        ...
        <div class="card-foot">
            <span class="foot-note">L = (I &minus; A)⁻¹ &nbsp;&mdash;&nbsp; nilai menunjukkan total output yang dibutuhkan seluruh sektor per satu unit permintaan akhir</span>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    Swal.fire({
        ...
        text: 'Matrix tidak dapat diinvers karena singular matrix.',
        confirmButtonColor: '#2563eb',
        confirmButtonText: 'Kembali'
    }).then(() => {
        window.location.href = "{{ route('io.index') }}";
    });
    ...
    Swal.fire({
        icon: 'success',
        title: 'Berhasil',
        text: 'Leontief Inverse berhasil dihitung.',
        timer: 2200,
