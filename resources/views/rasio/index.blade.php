...
<script>
    ...
    $(function() {
        ...
        $('#saveAll').on('click', function() {
            ...
            $('#rasioTable tbody tr').each(function() {
                ...
                $(this).find('input.rasioOutputIkutan').each(function() {
                    ...
                    const rasioOutputIkutan = $(this).data('raw');
                    const rasioWipCbr = $(this).closest('tr')
                        .find(`input.rasioWipCbr[data-year="${year}"][data-triwulan="${triwulanId}"]`)
                        .data('raw');
                    const rasioBiayaAntara = $(this).closest('tr')
                        .find(`input.rasioBiayaAntara[data-year="${year}"][data-triwulan="${triwulanId}"]`)
                        .data('raw');

                    if (rasioOutputIkutan !== null && rasioOutputIkutan !== undefined && rasioOutputIkutan !== '' ||
                        rasioWipCbr !== null && rasioWipCbr !== undefined && rasioWipCbr !== '' ||
                        rasioBiayaAntara !== null && rasioBiayaAntara !== undefined && rasioBiayaAntara !== '') {

                        payload.push({
                            commodity_id: commodityId,
                            tahun: year,
                            triwulan_id: triwulanId,
                            rasio_output_ikutan: rasioOutputIkutan || null,
                            rasio_wip_cbr: rasioWipCbr || null,
                            rasio_biaya_antara: rasioBiayaAntara || null
                        });
                    }
                });
            });
        ...
        // HANYA SATU EVENT HANDLER UNTUK #saveCommodity
