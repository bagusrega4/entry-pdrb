    ...
    $(function() {
        ...
        $('#saveAll').on('click', function() {
            ...
            $('#ihpTable tbody tr').each(function() {
                ...
                // loop berdasarkan input ihp (karena setiap tahun pasti ada)
        ...
        $('#addCommodity').on('click', function() {
            ...
            $.get('/ihp/commodities/all', function(res) {
                res.forEach(c => {
            ...
            // isi indikator
            $.get('/ihp/indicators', function(res) {
            ...
            // isi satuan harga
            $.get('/ihp/unit-harga', function(res) {
            ...
            // isi satuan produksi
            $.get('/ihp/unit-produksi', function(res) {
        ...
        $('#parentSelect').on('change', function() {
            ...
            if (!parentId) {
                $.get(`/ihp/commodities/next-code`, function(res) {
                    $('#newKode').val(res.new_code);
                });
                return;
            }
            $.get(`/ihp/commodities/${parentId}/next-code`, function(res) {
                $('#newKode').val(res.new_code);
            });
        });
